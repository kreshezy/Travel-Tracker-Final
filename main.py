...
GitHub URL:https://github.com/kreshezy/Travel-Tracker-Final
"""
...
def placeBtnStyle(place,btn):
    '''Set the text and background color of the btn according to the place object'''
    if place.is_visited:
        ...
        btn.background_color=[0.1,0.95,0.95,1.0]
